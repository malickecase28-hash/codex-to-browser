...
const REQUIRED_FILES = [
  ...
  "dist/src/dev/autonomous-snapshot.js",
  "dist/src/dev/autonomous-snapshot.d.ts",
  ...
  "dist/src/dev/codex-cli-safe-local-port.js",
  "dist/src/dev/codex-cli-safe-local-port.d.ts",
