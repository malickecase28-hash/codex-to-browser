import { ConversationRegistry } from "../conversations/registry.js";
async function main() {
    ...
    if (command === "remember") {
        ...
        if (conversationId === undefined && url === undefined)
            throw new Error("remember requires --conversation-id or --url.");
        ...
        if (surface !== undefined)
            args.surface = parseSurface(surface);
...
function requiredPosition(values, index, label) {
