export declare const OPERATION_SCHEMA_VERSION: "chatgpt.browser_control.operation.v1";
export declare const OPERATION_EVENT_SCHEMA_VERSION: "chatgpt.browser_control.operation_event.v1";
export declare const OPERATION_RECEIPT_SCHEMA_VERSION: "chatgpt.browser_control.operation_receipt.v1";
export declare const OPERATION_REQUEST_SCHEMA_VERSION: "chatgpt.browser_control.operation_request.v1";
export declare const OPERATION_HANDLE_SCHEMA_VERSION: "chatgpt.browser_control.operation_handle.v1";
export declare const OPERATION_COLLECT_REQUEST_SCHEMA_VERSION: "chatgpt.browser_control.operation_collect_request.v1";
export declare const OPERATION_INSPECT_REQUEST_SCHEMA_VERSION: "chatgpt.browser_control.operation_inspect_request.v1";
export declare const OPERATION_CONTROL_REQUEST_SCHEMA_VERSION: "chatgpt.browser_control.operation_control_request.v1";
export declare const OPERATION_CONTROL_RECEIPT_SCHEMA_VERSION: "chatgpt.browser_control.operation_control_receipt.v1";
export declare const OPERATION_ARTIFACT_RECEIPT_SCHEMA_VERSION: "chatgpt.browser_control.operation_artifact_receipt.v1";
export declare const OPERATION_BLOCKER_SCHEMA_VERSION: "chatgpt.browser_control.operation_blocker.v1";
export declare const OPERATION_RECOVERY_OBSERVATION_SCHEMA_VERSION: "chatgpt.browser_control.operation_recovery_observation.v1";
export declare const OPERATION_RECOVERY_DECISION_SCHEMA_VERSION: "chatgpt.browser_control.operation_recovery_decision.v1";
/** Redacted exact post-Send ownership proof retained in the authenticated journal. */
export declare const OPERATION_SUBMISSION_WITNESS_SCHEMA_VERSION: "chatgpt.browser_control.operation_submission_witness.v1";
/** Redacted complete pre-Send ownership baseline retained before activation. */
export declare const OPERATION_OWNERSHIP_BASELINE_SCHEMA_VERSION: "chatgpt.browser_control.operation_ownership_baseline.v1";
/** Durable transfer records reuse the provider-agnostic artifact-transfer protocol exactly. */
export declare const OPERATION_ARTIFACT_TRANSFER_INTENT_SCHEMA_VERSION: "chatgpt.browser_control.artifact_transfer_intent.v1";
export declare const OPERATION_ARTIFACT_TRANSFER_RECEIPT_SCHEMA_VERSION: "chatgpt.browser_control.artifact_transfer_receipt.v1";
import type { ArtifactTransferDurableState, ArtifactTransferIntentV1, ArtifactTransferReceiptV1 } from "./artifact-transfer.js";
import type { OwnershipBaseline } from "./turn-ownership.js";
export type OperationSurface = "chat" | "work";
export type OperationJsonValue = null | boolean | number | string | OperationJsonValue[] | {
...
export type OperationPhase = "prepared" | "handoff_pending" | "ready" | "send_pending" | "submitted" | "generating" | "capturing" | "completed" | "uncertain";
export type MutationBoundary = "none" | "handoff_may_have_occurred" | "send_may_have_occurred" | "control_may_have_occurred";
export type OperationRepeatPolicy = "read_only" | "reconcile_set_to_value" | "reconcile_local_effect" | "observe_only_after_intent";
export type OperationActionKind = "status_read" | "configuration_set" | "tool_set" | "composer_set" | "power_discovery" | "power_select" | "file_handoff" | "send" | "work_steer" | "stop" | "download" | "local_output_commit" | "clipboard_capture_restore";
...
export type OperationEventV1 = OperationCreatedEventV1 | OperationTargetBoundEventV1 | OperationTargetEstablishedEventV1 | OperationOwnershipBaselineEventV1 | OperationSubmissionWitnessEventV1 | OperationActionIntentEventV1 | OperationActionPreparedEventV1 | OperationArtifactTransferIntentEventV1 | OperationArtifactTransferReceiptEventV1 | OperationActionReceiptEventV1 | OperationPhaseChangedEventV1 | OperationBlockerObservedEventV1 | OperationReceiptCompletedEventV1 | OperationContentAvailabilityEventV1;
