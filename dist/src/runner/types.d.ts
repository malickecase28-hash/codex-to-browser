import type { AttachedFile, ChatGPTExperience, CommandResult, CommandStatus, CompletionState, ConfigurationSelection, CopyResponseArgs, DownloadLatestArgs, BootstrapArgs, ReadLatestArgs, ResponseCaptureFidelity, ResponseCaptureSource, ResponseFormat, SequencePlan, SelectToolArgs, SetModeArgs, SubmissionState, ThreadTarget, WaitArgs } from "../types.js";
...
export type ChatGPTInputItem = {
    ...
    type: "visible_instruction";
    text: string;
};
export type ChatGPTRunInput = string | {
...
export type ChatGPTInterruption = {
    id: string;
    type: "approval_required" | "permission_required" | "login_required" | "selector_drift" | "rate_limit" | "captcha" | "unsupported" | "timeout";
...
export type ChatGPTConfirmation = {
    targetKind: "file_upload" | "download" | "thread" | "shared_link" | "third_party_app" | "account_setting" | "workspace_setting" | "external_action" | "quota_consuming_tool";
...
export type ChatGPTRunner = {
    run<TOutput = string>(agent: ChatGPTAgent<TOutput>, input: ChatGPTRunInput, options: {
        stream: true;
