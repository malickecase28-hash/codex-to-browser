...
export function extractMessagesFromHtml(html, args = {}) {
...
export async function readMessages(page, args = {}) {
...
export async function readLatestMessage(page, role = "assistant", format = "markdown", maxChars) {
    if (typeof page.evaluate === "function") {
...
export async function readLatestMessageText(page, role = "assistant") {
    if (typeof page.evaluate === "function") {
...
export async function readLatestMessageTextSnapshot(page, role) {
    if (typeof page.evaluate === "function") {
        return page.evaluate((wantedRole) => {
            ...
            const snapshot = { turnCount: allNodes.length };
...
export function isTransientAssistantText(text) {
...
export function countMessages(messages, role) {
    return role === undefined ? messages.length : messages.filter(message => message.role === role).length;
}
export async function countPageMessages(page, role) {
    if (typeof page.evaluate === "function") {
        return page.evaluate((wantedRole) => {
