...
const generatedArtifactDownloadClauses = [
    ...
    ...localeLabels.imageContainerHint.flatMap(hint => localeLabels.download.flatMap(label => [
...
export function composerTextbox(page) {
...
export function stopGenerationButton(page) {
    if (typeof page.getByRole !== "function") {
...
export function copyResponseButtons(page) {
    if (typeof page.getByRole !== "function") {
